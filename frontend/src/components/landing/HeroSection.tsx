    ...
    <section className="relative overflow-hidden px-0 pb-20 pt-14 lg:pt-20">
      <div className="app-container grid items-center gap-10 lg:grid-cols-[1.2fr_1fr]">
        <div className="reveal-up">
          <h1 className="text-hero-title max-w-3xl text-4xl font-extrabold leading-tight md:text-5xl lg:text-6xl">
          ...
          <p className="text-hero-copy mt-5 max-w-2xl text-base md:text-lg">
            A production-ready escrow protocol for clients and freelancers. Funds
            stay protected until milestones are accepted, with transparent payout
            history and an optional dispute flow.
          </p>
          ...
          <div className="mt-10 grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
            {HERO_STATS.map((stat, index) => (
              ...
              >
                <p className="text-primary text-center text-xl font-bold">{stat.value}</p>
